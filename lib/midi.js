...
/*!
 * Lightly modified version of jsmidi by Sergi Mansilla
 *
 * This material is licensed by Sergi Mansilla under the Creative Commons
 * Attribution-ShareAlike 3.0 license. You are free to copy, distribute,
 * transmit, and remix this work, provided you attribute the work to Sergi
 * Mansilla as the original author and reference this repository. If you alter,
 * transform, or build upon this work, you may distribute the resulting work
 * only under the same, similar or compatible license. Any of the above
 * conditions can be waived if you get permission from the copyright holder.
 * For any reuse or distribution, you must make clear to others the license
 * terms of this work. The best way to do this is with a link to the Creative
...
MidiTrack.prototype = {
    ...
    setText: function(type, text) {
        ...
        return this.addEvent(new MetaEvent({ time: 0, type: type, data: text }));
    },
    ...
    setTempo: function(tempo) {
        this.addEvent(new MetaEvent({ time: 0, type: META_TEMPO, data: mpqnFromBpm(tempo) }));
    },
    setTimeSig: function() {
        // TBD
    },
