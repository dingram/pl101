...
var testrunner = function(test_cases, executor) {
  ...
  for (var i=0, l=test_cases.length; i<l; ++i) {
    ...
    if (result !== false) {
      ...
      if (e) { console.log(sys.inspect(e, false, null)); console.log("\n"); }
    }
  }
  console.log("\n------------------------------------------------------------------------");
  if (failed == 0) {
    console.log("\nAll tests \033[1;32mPASSED\033[m.");
  } else if (passed == 0) {
    console.log("\nAll tests \033[1;31mFAILED\033[m.");
  } else {
    console.log("\n\033[1;32mPASSED\033[m: "+passed+"\n\033[1;31mFAILED\033[m: "+failed);
    console.log("\nSome tests \033[1;31mFAILED\033[m.");
  }
}
