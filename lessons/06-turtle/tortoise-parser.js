  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_statement() {
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, line, column, expr, body) { return { tag:"if", expr:expr, body:body }; })(pos0.offset, pos0.line, pos0.column, result0[4], result0[10]);
            }
            if (result0 === null) {
              pos = clone(pos0);
            }
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 === null) {
              ...
              result0 = parse_identifier();
              if (result0 !== null) {
                result0 = (function(offset, line, column, v) { return { tag:"ident", name: v }; })(pos0.offset, pos0.line, pos0.column, result0);
              }
              if (result0 === null) {
                pos = clone(pos0);
              }
      ...
      function parse_number() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, sign, chars, frac) { return parseFloat(sign + chars.join('') + frac); })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1], result0[2]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
