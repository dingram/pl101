  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "unescapedChar": parse_unescapedChar,
        "escapedChar": parse_escapedChar,
        "unicodeEscapeChar": parse_unicodeEscapeChar,
      ...
      function parse_statement() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, v) { return { tag:"var", vars:v }; })(pos0.offset, pos0.line, pos0.column, result0[2]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_var_init() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, n) { return { name:n, value:undefined }; })(pos0.offset, pos0.line, pos0.column, result0[0]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_sqStrChar() {
        ...
        result0 = parse_unescapedChar();
        if (result0 === null) {
          result0 = parse_unicodeEscapeChar();
          if (result0 === null) {
            pos0 = clone(pos);
            pos1 = clone(pos);
      ...
      function parse_unicodeEscapeChar() {
        var result0, result1, result2, result3, result4;
        var pos0, pos1;
      ...
      function parse_primary() {
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, line, column) { return undefined; })(pos0.offset, pos0.line, pos0.column);
            }
            if (result0 === null) {
              pos = clone(pos0);
            }
              ...
              if (result0 === null) {
                ...
                if (result0 === null) {
                  ...
                  if (result0 === null) {
                    ...
                    if (result0 !== null) {
                      result0 = (function(offset, line, column, body) { return { tag:'function', args:[], body:body }; })(pos0.offset, pos0.line, pos0.column, result0[8]);
                    }
                    if (result0 === null) {
                      pos = clone(pos0);
                    }
                    if (result0 === null) {
                      ...
                      if (result0 !== null) {
                        result0 = (function(offset, line, column, args, body) { return { tag:'function', args:args, body:body }; })(pos0.offset, pos0.line, pos0.column, result0[4], result0[10]);
                      }
                      if (result0 === null) {
                        pos = clone(pos0);
                      }
