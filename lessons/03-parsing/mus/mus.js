...
var test_cases = [
	...
	{ message: 'Quarter note with length at tempo 120',
		input: "\\tempo 120 a4:4",
		output: {tag:'seq', left: {tag:'tempo', base: 4, tempo: 120}, right: {tag:'note', pitch: 'a4', dur: 500, len: 4} } },
	{ message: 'Quarter note with length at tempo 8=120',
		input: "\\tempo 8=120 a4:4",
		output: {tag:'seq', left: {tag:'tempo', base: 8, tempo: 120}, right: {tag:'note', pitch: 'a4', dur: 1000, len: 4} } },
